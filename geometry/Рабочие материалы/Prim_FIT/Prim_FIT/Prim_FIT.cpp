...
// Prim_FIT.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CPrim_FITApp

CPrim_FITApp theApp;


// инициализация CPrim_FITApp
...
// обработчики сообщений CPrim_FITApp
