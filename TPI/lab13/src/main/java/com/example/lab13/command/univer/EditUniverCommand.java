...
public class EditUniverCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException, IncorrectDataException {
        ...
        if (id.orElse("").isEmpty() || name.orElse("").isEmpty() || city.orElse("").isEmpty()|| foundation.orElse("").isEmpty()) {
            LOGGER.warning("Invalid id  format was received: " + id + name + " " + city + " " + foundation);
